...
class Diff::LCS::Hunk
  ...
  def unified_diff(last = false)
    ...
    '\\ No newline at end of file'.encode(@preferred_data_encoding)
    # standard:disable Performance/UnfreezeString
    outlist = @data_old[lo..hi].map { |e| String.new("#{space}#{e.chomp}") }
  ...
  def context_diff(last = false)
    ...
    unless removes.empty?
      # standard:disable Performance/UnfreezeString
      outlist = @data_old[lo..hi].map { |e| String.new("#{spaces}#{e.chomp}") }
      # standard:enable Performance/UnfreezeString
    ...
    unless inserts.empty?
      # standard:disable Performance/UnfreezeString
      outlist = @data_new[lo..hi].map { |e| String.new("#{spaces}#{e.chomp}") }
      # standard:enable Performance/UnfreezeString
