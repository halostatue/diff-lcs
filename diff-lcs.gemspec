...
Gem::Specification.new do |s|
  ...
  s.files = Dir["Code-of-Conduct.md".freeze, "Contributing.md".freeze, "History.md".freeze, "License.md".freeze, "Manifest.txt".freeze, "README.rdoc".freeze, "docs/*.txt".freeze, "lib/**/*.rb".freeze, "bin/*".freeze]  
